        ...
        <div class="filter-tab">
            ...
            <div class="rightside">
                ...
                <div class="search-container b-orange br-5 ">
                    ...
                    <input type="text" id="moduleSearchInput" data-url="search-fan" placeholder="Search Story....">
                </div>
            </div>
        </div>
         ...
         <div class="select-wrapper b-orange br-5 mb-2">
            ...
            <span id="tableResults">
                ...
                @include('backend.fan_gallery.fan_table',['fans' => $fans])
