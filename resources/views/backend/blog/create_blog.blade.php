                ...
                <section class="">
                    <div class="row">
                        <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label for="slug"> URL Slug </label>
                                    <input type="text" class="" name="slug" id="slug" placeholder="Enter url...." value="{{ old('slug') }}">
                                </div>
                                ...
                                <div class="form-group choose-image">
                                    <div class="upload-container">
                                        ...
                                        <div class="upload-box" id="uploadBox">
                                            ...
                                            <p class="f-14 c-light f-w-5 freedoka">Drag & drop an image here, or <span class="c-skyblue">browse file</span></p></label>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea id="Summary" name="summary" placeholder="Enter excerpt/summary">{{ old('summary') }}</textarea>
                                </div>
                                <div class="form-group">
